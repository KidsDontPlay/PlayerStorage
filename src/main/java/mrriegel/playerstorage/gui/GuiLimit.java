...
public class GuiLimit extends CommonGuiScreenSub {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		fontRenderer.drawString("Limitation", 7 + guiLeft, 7 + guiTop, 0x2e2e2e);
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 0) {
			...
			NBTHelper.set(nbt, "min", Integer.parseInt(min.getText()));
			NBTHelper.set(nbt, "max", Integer.parseInt(max.getText()));
